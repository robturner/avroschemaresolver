...
public class TestValidatingIO {
  ...
  private static void printSchemaAndValues(String schemaType, Schema schema, Object[] values) {
    LOG.info("{} Schema {}", schemaType, schema); 
    for (Object value : values) {
      LOG.info("{} -> {}", value, value.getClass().getSimpleName());
    }
  }  

  private static void printSchemaAndValues(String schemaType, Schema schema, String values) {
    LOG.info("{} Schema {}", schemaType, schema); 
    LOG.info("{}", values); 
  }
}
