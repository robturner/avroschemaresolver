...
//    r.add(new Object[] { CodecFactory.xzCodec(6) });
  ...
  private static final boolean VALIDATE =
    !"false".equals(System.getProperty("test.validate", "false"));
  ...
  private File makeFile() {
   ...
   @Test public void testGenericWrite() throws IOException {
  ...
  @Test public void testGenericRead() throws IOException {
