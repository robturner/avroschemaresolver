...
class ArrayAccessor {
  ...
  static boolean[] readArray(boolean[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
  ...
  static int[] readArray(int[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
      int limit = index + (int) l;
  ...
  static short[] readArray(short[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
      int limit = index + (int) l;
  ...
  static char[] readArray(char[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
      int limit = index + (int) l;
  ...
  static long[] readArray(long[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
      int limit = index + (int) l;
  ...
  static float[] readArray(float[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
      int limit = index + (int) l;
  ...
  static double[] readArray(double[] array, long l, Decoder in)
      throws IOException {
    int index = 0;
    do {
      int limit = index + (int) l;
