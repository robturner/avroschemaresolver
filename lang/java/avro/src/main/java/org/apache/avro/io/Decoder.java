...
public abstract class Decoder {
  ...
  /**
   * Reads the tag of a union written by {@link Encoder#writeIndex}.
   * @return The union tag name or null if no tag name is available.
   * @throws AvroTypeException If this is a stateful reader and
   *          union is not the type of the next value to be read.
   * @throws IOException
   */
  ...
  /**
   * Reads the start of a union written by {@link Encoder#writeUnionStart}.
   * @throws AvroTypeException If this is a stateful reader and
   *         union is not the type of the next value to be read
   */
  ...
  /**
   * Reads the end of a union written by {@link Encoder#writeUnionEnd}.
   * @throws AvroTypeException If this is a stateful reader and
   *         union is not the type of the next value to be read
   */
  ...
  /**
   * Reads the tag of an enumeration written by {@link Encoder#writeEnum}.
   * @return The enumeration's tag name or null if no tag name is available.
   * @throws AvroTypeException If this is a stateful reader and
   *          enumeration is not the type of the next value to be read.
   * @throws IOException
   */
  ...
  /**
   * Reads the start of a record written by {@link Encoder#writeRecordStart}.
   * @throws AvroTypeException If this is a stateful reader and
   *         record is not the type of the next value to be read
   */
  public void readRecordStart() throws IOException {
  }

  /**
   * Reads the end of a record written by {@link Encoder#writeRecordEnd}.
   * @throws AvroTypeException When called outside of a
   *         record context
   */
  ...
  /**
   * Reads the next field name written by {@link Encoder#startField}.
   * @return String field name or null if no more field names are available. 
   * @throws AvroTypeException When called outside of a
   *         field context
   */
  ...
  /**
   * Reads the map key written by {@link Encoder#writeMapKey}.
   * @throws AvroTypeException When called outside of a
   *         field context
   */
