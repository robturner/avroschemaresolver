...
public class GenericDatumWriter<D> implements DatumWriter<D> {
  ...
  protected void write(Schema schema, Object datum, Encoder out)
    ...
    try {
      ...
      case UNION:
        ...
        out.writeUnionStart();
        Schema typeSchema = schema.getTypes().get(index);
        out.writeIndex(index, typeSchema.getFullName());
        write(typeSchema, datum, out);
        out.writeUnionEnd();
        break;
  ...
  protected void writeRecord(Schema schema, Object datum, Encoder out)
    ...
    for (Field f : schema.getFieldsAsArray()) {
  ...
  protected void writeEnum(Schema schema, Object datum, Encoder out)
    throws IOException {
    String eTag = datum.toString();
    out.writeEnum(schema.getEnumOrdinal(eTag), eTag);
  }
  ...
  protected void writeMap(Schema schema, Object datum, Encoder out)
    ...
    for (Map.Entry<Object,Object> entry : getMapEntries(datum)) {
      out.startItem();
      out.writeMapKey(entry.getKey().toString());
