...
public class EncoderFactory {
  ...
  /**
   * Returns an immutable static EncoderFactory with default configuration.
  ...
  /**
   * Creates a {@link JsonBasicEncoder} using the OutputStream provided for writing.
   * <p/>
   * {@link JsonBasicEncoder} buffers its output. Data may not appear on the
   * underlying OutputStream until {@link Encoder#flush()} is called.
   * <p/>
   * {@link JsonBasicEncoder} is not thread-safe.
   * 
   * @param out
   *          The OutputStream to write to. Cannot be null.
   * @return A JsonBasicEncoder configured with <i>out</i>
   * @throws IOException
   */
  public JsonBasicEncoder jsonBasicEncoder(OutputStream out)
      throws IOException {
    return new JsonBasicEncoder(out);
  }
   ...
   * @param pretty
   *          Pretty print encoding.
   * @return A JsonBasicEncoder configured with <i>out</i> and <i>pretty</i>
   * @throws IOException
   */
  public JsonBasicEncoder jsonBasicEncoder(OutputStream out, boolean pretty)
      throws IOException {
    return new JsonBasicEncoder(out, pretty);
  }
