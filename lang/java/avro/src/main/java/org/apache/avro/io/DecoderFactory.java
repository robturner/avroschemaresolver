...
public class DecoderFactory {
   ...
   * 
   * @param schema
   *          The Schema for data read from this JsonDecoder. Cannot be null.
   * @param input
   *          The InputStream to read from. Cannot be null.
   * @return A JsonDecoder configured with <i>input</i> and <i>schema</i>
   * @throws IOException
   */
  ...
  /**
   * Creates a {@link JsonBasicDecoder} using the InputStream provided for reading.
   * <p/>
   * 
   * @param input
   *          The InputStream to read from. Cannot be null.
   * @return A JsonDecoder configured with <i>input</i>
   * @throws IOException
   */
  public JsonBasicDecoder jsonBasicDecoder(InputStream input)
      throws IOException {
    return new JsonBasicDecoder(input);
  }
  
  /**
   * Creates a {@link JsonBasicDecoder} using the String provided for reading data.
   * <p/>
   * 
   * @param input
   *          The String to read from. Cannot be null.
   ...
   * @throws IOException
   */
  public JsonBasicDecoder jsonBasicDecoder(String input)
      throws IOException {
    return new JsonBasicDecoder(input);
  }
